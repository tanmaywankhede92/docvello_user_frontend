      ...
      <div className="bg-[#F5F3EE] max-w-7xl mx-auto min-h-screen px-4 md:px-10 py-10">
        ...
        <div className="flex items-start gap-5">
          ...
          <div>
            ...
            <p className="text-[22px] text-[#9C9C9C] mt-5 font-medium">
              Comprehensive care for heart and blood vessel conditions.
            </p>
        ...
        <div className="bg-[#41B89A] rounded-[28px] mt-12 px-8 py-10 shadow-lg">
          ...
          <p className="text-white text-[22px] leading-[42px] font-medium">
            Cardiology is a medical specialty focused on the diagnosis, treatment, and prevention of disorders of the heart and cardiovascular system. Our world class cardiologists utilize advanced diagnostic tools and innovative treatments to ensure optimal heart health, managing everything from routine check-ups to complex cardiac interventions.
          </p>
        ...
        <div className="mt-24 text-center">
          ...
          <div>
            ...
            <h2 className="text-center font-bold font-heading text-[#0E1B25] text-5xl mb-14 mt-24">
              Treatment Options
            </h2>
            ...
            <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-[#F8F8F8] border border-gray-400 rounded-[30px] p-10 text-center hover:shadow-lg duration-300">
                ...
                <img
                  ...
                  className="w-28 h-28 object-contain mx-auto mb-6 font-bold font-heading"
                />

                <h3 className="text-[24px] text-[#111827] mb-4 font-bold font-heading">
                  Echocardiography
                </h3>
